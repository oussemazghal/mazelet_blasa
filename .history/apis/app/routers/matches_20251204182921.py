...
def delete_match(
    ...
    # Send emails
    print(f"📧 Sending cancellation emails to {len(unique_participants)} participants...")
    for player in unique_participants:
        if player.email and player.id != current_user.id: # Don't email the organizer who deleted it
