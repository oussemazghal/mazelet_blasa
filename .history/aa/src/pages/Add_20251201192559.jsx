                ...
                <div style={{ display: "flex", gap: "10px" }}>
                  <button
                    ...
                    style={{
                      flex: 1,
                      padding: "10px",
                      border: matchMode === "individual" ? "2px solid #2196F3" : "1px solid #ccc",
                  ...
                  <button
                    ...
                    style={{
                      flex: 1,
                      padding: "10px",
                      border: matchMode === "team_vs_team" ? "2px solid #2196F3" : "1px solid #ccc",
            ...
            <div className="step-box">
              ...
              <label>Total Players
                <input
                  ...
                  required
                  disabled={matchMode === "team_vs_team"} // Optional: disable if strictly 2 teams, but maybe keep for info
                />
              </label>
