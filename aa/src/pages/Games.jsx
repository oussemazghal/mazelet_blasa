...
export default function Games() {
  ...
  async function handleJoinAsTeam() {
    ...
    if (selectedTeam && match) {
      ...
      // Use type_match as source of truth if nb_players is missing/0
      const requiredPlayers = match.type_match ? parseInt(match.type_match.split('v')[0]) : (match.nb_players / 2);
      ...
      if (teamSize !== requiredPlayers) {
        alert(`Your team must have exactly ${requiredPlayers} members (including you) to join this ${match.type_match} match. Currently you have ${teamSize}.`);
        return;
      }
    }
