...
export default function MyGames() {
    ...
    if (loading) return <div className="my-games-page">Loading...</div>;
            ...
            {joinedMatches.length === 0 ? (
                ...
                <div className="games-list">
                    {joinedMatches.map((match) => {
                        ...
                        let myTeam = null; // ⭐ Declare myTeam here
                        ...
                        if (match.is_team_match && user) {
                            ...
                            myTeam = inTeamA ? match.team_a : match.team_b; // ⭐ Assign value here
                        ...
                        return (
                            <div key={match.id} className="game-card" style={{ borderColor: "#4CAF50" }}>
                                <h2>{match.title}</h2>
                                {match.is_team_match && myTeam && (
                                    <div style={{ background: "#e3f2fd", color: "#1565c0", padding: "4px 8px", borderRadius: "4px", fontSize: "12px", display: "inline-block", marginBottom: "8px", fontWeight: "bold" }}>
                                        🛡️ Participated with: {myTeam.name}
                                    </div>
                                )}
